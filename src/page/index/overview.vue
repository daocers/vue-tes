            ...
            <el-card shadow="hover" :body-style="{padding: '0px'}">
              <div class="grid-content grid-con-1">
                <div class="grid-con-icon">
                  <img src="../../assets/img/user_white.png"/>
                </div>
          ...
          <el-col :span="8">
            <el-card shadow="hover" :body-style="{padding: '0px'}">
              <div class="grid-content grid-con-2">
                <div class="grid-con-icon">
                  <i class="iconfont tes-icon-ques-manage"/>
                </div>
                <div class="grid-cont-right">
          ...
          <el-col :span="8">
            <el-card shadow="hover" :body-style="{padding: '0px'}">
              <div class="grid-content grid-con-3">
                <div class="grid-con-icon">
                  <i class="iconfont tes-icon-scene"/>
                </div>
                <div class="grid-cont-right">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        name: 'Allen',
        headImgUrl: 'http://blog.gdfengshuo.com/example/work/static/img/img.jpg',
        todoList: [{
          title: '今天要修复100个bug',
          status: false,
        },
