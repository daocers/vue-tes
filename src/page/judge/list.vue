    ...
    export default {
        ...
        methods: {
            ...
            findByCondition: async function () {
                let data = await this.http("/judge/v1/findByCondition?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
            ...
            commitData: async function () {
                ...
                this.$refs['editForm'].validate(async (valid) => {
                    if (!valid) {
                        ...
                        var res = await this.http('/judge/v1/save', this.dataForEdit, 3000);
                        if (res) {
        ...
        let data = await this.http("/judge/v1/delete?id=" + row.id);
        if (data == true) {
