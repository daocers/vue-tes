    ...
    <div id="add">
        <el-row>
            <el-col :span="18">
                ...
                <el-form label-position="left" :model="department" :rules="rules" ref="addForm" label-width="80px">
                            ...
                            <el-input v-model="department.status" placeholder="请输入"></el-input>
                        </el-form-item>
                                            <el-form-item label="createTime" prop="createTime">
                            <el-input v-model="department.createTime" placeholder="请输入"></el-input>
                        </el-form-item>
                                            <el-form-item label="createUserId" prop="createUserId">
                            <el-input v-model="department.createUserId" placeholder="请输入"></el-input>
                        </el-form-item>
                                            <el-form-item label="updateTime" prop="updateTime">
                            <el-input v-model="department.updateTime" placeholder="请输入"></el-input>
                        </el-form-item>
                                            <el-form-item label="updateUserId" prop="updateUserId">
                            <el-input v-model="department.updateUserId" placeholder="请输入"></el-input>
                        </el-form-item>
            ...
            add() {
                this.$refs['addForm'].validate(async (valid) => {
                    if (!valid) {
                        ...
                        let res = await this.postEntity("/department/api/save", this.department);
                        if (res == true) {
