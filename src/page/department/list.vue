...
//            ],
    ...
    methods: {
      ...
      findByCondition: async function () {
        let data = await this.http("/department/api/findByCondition.do?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
...
//        关闭对话框
      ...
      async toRemove(idx, row) {
        ...
        let data = await this.http("/department/api/delete.do?id=" + row.id);
        if (data == true) {
