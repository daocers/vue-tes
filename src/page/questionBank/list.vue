...
//              {required: true, message: '请输入memo', trigger: 'blur'},
    ...
    methods: {
      ...
      findByCondition: async function () {
        let data = await this.doPost("/questionBank/api/findByCondition?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
      ...
      updateData: async function () {
        ...
        this.$refs['editForm'].validate(async (valid) => {
          if (!valid) {
            ...
            var res = await this.doPost('/questionBank/api/save', this.dataForEdit);
            if (res) {
      ...
      addData: async function () {
        ...
        this.$refs['addForm'].validate(async (valid) => {
          if (!valid) {
            ...
            let res = await this.doPost("/questionBank/api/save", this.dataForAdd);
            if (res == true) {
...
//        关闭对话框
      ...
      async toRemove(idx, row) {
        ...
        let data = await this.doPost("/questionBank/api/delete?id=" + row.id);
        if (data == true) {
