    ...
    <div class="table">
        ...
        <el-dialog title="编辑" :visible.sync="editDialogShow">
            <el-form ref="editForm" :rules="rules" label-position="left" :model="dataForEdit">
                        ...
                        <el-input v-model="dataForEdit.examFlag" placeholder="请输入"></el-input>
                    </el-form-item>
        ...
        <el-dialog title="添加" :visible.sync="addDialogShow">
            <el-form ref="addForm" :rules="rules" label-position="left" :model="dataForAdd">
                        ...
                        <el-input v-model="dataForAdd.userId" placeholder="请输入"></el-input>
                                    ...
                                    <el-form-item label="examFlag" prop="examFlag">
                        <el-input v-model="dataForAdd.examFlag" placeholder="请输入"></el-input>
                    </el-form-item>
                                    <el-form-item label="isDel" prop="isDel">
    ...
    export default {
        ...
        methods: {
            ...
            findByCondition: async function () {
                let data = await this.postEntity("/profile/api/findByCondition?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
            ...
            updateData: async function () {
                ...
                this.$refs['editForm'].validate(async (valid) => {
                    if (!valid) {
                        ...
                        var res = await this.postEntity('/profile/api/update', this.dataForEdit, 1000);
                        if (res) {
            ...
            addData: async function () {
                ...
                this.$refs['addForm'].validate(async (valid) => {
                    if (!valid) {
                        ...
                        let res = await this.postEntity("/profile/api/save", this.dataForAdd, 1000);
                        if (res == true) {
...
//        关闭对话框
            ...
            async toRemove(idx, row) {
                ...
                let data = await this.postEntity("/profile/api/delete?id=" + row.id);
                if (data == true) {
