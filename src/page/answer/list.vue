  ...
  export default {
    ...
    methods: {
      ...
      findByCondition: async function () {
        let data = await this.http("/answer/api/findByCondition?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
...
//            this.editDialogShow = false;
      ...
      async toRemove(idx, row) {
        ...
        let data = await this.http("/answer/api/delete?id=" + row.id);
        if (data == true) {
