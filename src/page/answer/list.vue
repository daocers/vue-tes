    ...
    <div class="table">
        ...
        <el-dialog title="添加" :visible.sync="addDialogShow">
            <el-form ref="addForm"  :rules="rules" label-position="left" :model="dataForAdd">
                                <el-form-item label="paperId" prop="paperId">
                      <el-input v-model="dataForAdd.paperId" placeholder="请输入"></el-input>
                  </el-form-item>
                                <el-form-item label="questionId" prop="questionId">
                      <el-input v-model="dataForAdd.questionId" placeholder="请输入"></el-input>
                  </el-form-item>
                                <el-form-item label="questionTypeId" prop="questionTypeId">
                      ...
                      <el-input v-model="dataForAdd.answer" placeholder="请输入"></el-input>
                                ...
                                <el-form-item label="timeUsed" prop="timeUsed">
                      <el-input v-model="dataForAdd.timeUsed" placeholder="请输入"></el-input>
                  </el-form-item>
                                <el-form-item label="timeLeft" prop="timeLeft">
                      <el-input v-model="dataForAdd.timeLeft" placeholder="请输入"></el-input>
                  </el-form-item>
                                <el-form-item label="isDel" prop="isDel">
...
let res = await this.http("/answer/api/save.do", this.dataForAdd, 1000);
if (res == true) {
