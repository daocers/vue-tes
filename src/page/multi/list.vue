    ...
    <div class="table">
        ...
        <el-dialog v-bind:title="dataForEdit.id ? '编辑': '添加'" :visible.sync="editDialogShow" width="60%">
            <el-form ref="editForm" :rules="rules" label-position="left" :model="dataForEdit">
                                    <el-form-item label="title" prop="title"  :label-width="labelWidth">
                        <el-input v-model="dataForEdit.title" placeholder="请输入"></el-input>
                    </el-form-item>
                                    <el-form-item label="answer" prop="answer"  :label-width="labelWidth">
                        <el-input v-model="dataForEdit.answer" placeholder="请输入"></el-input>
                    </el-form-item>
                                    <el-form-item label="content" prop="content"  :label-width="labelWidth">
                        <el-input v-model="dataForEdit.content" placeholder="请输入"></el-input>
                    </el-form-item>
                                    <el-form-item label="extraInfo" prop="extraInfo"  :label-width="labelWidth">
                        <el-input v-model="dataForEdit.extraInfo" placeholder="请输入"></el-input>
                    </el-form-item>
                                    <el-form-item label="bankId" prop="bankId"  :label-width="labelWidth">
                        ...
                        <el-input v-model="dataForEdit.stationId" placeholder="请输入"></el-input>
                                    ...
                                    <el-form-item label="ownerId" prop="ownerId"  :label-width="labelWidth">
                        <el-input v-model="dataForEdit.ownerId" placeholder="请输入"></el-input>
                    </el-form-item>
                                    <el-form-item label="publicFlag" prop="publicFlag"  :label-width="labelWidth">
    ...
    export default {
        ...
        methods: {
            ...
            findByCondition: async function () {
                let data = await this.http("/multi/v1/findByCondition?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
            ...
            commitData: async function () {
                ...
                this.$refs['editForm'].validate(async (valid) => {
                    if (!valid) {
                        ...
                        var res = await this.http('/multi/v1/save', this.dataForEdit, 3000);
                        if (res) {
        ...
        let data = await this.http("/multi/v1/delete?id=" + row.id);
        if (data == true) {
