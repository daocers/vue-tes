        ...
        <el-row>
            <el-col :span="18">
                ...
                <el-form label-position="left" :model="propertyItem" :rules="rules" ref="addForm" label-width="80px">
                            ...
                            <el-input v-model="propertyItem.memo" placeholder="请输入"></el-input>
                        </el-form-item>
                                            <el-form-item label="propertyId" prop="propertyId">
                            <el-input v-model="propertyItem.propertyId" placeholder="请输入"></el-input>
                        </el-form-item>
                                            <el-form-item label="status" prop="status">
                            <el-input v-model="propertyItem.status" placeholder="请输入"></el-input>
                        </el-form-item>
            ...
            add() {
                this.$refs['addForm'].validate(async (valid) => {
                    if (!valid) {
                        ...
                        let res = await this.doPost("/propertyItem/api/save", this.propertyItem);
                        if (res == true) {
