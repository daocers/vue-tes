...
//        this.$refs.upload.clearFiles();
      ...
      findByCondition: async function () {
        let data = await this.doPost("/commonQuestion/api/findByCondition?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
      ...
      updateData: async function () {
        ...
        this.$refs['editForm'].validate(async (valid) => {
          if (!valid) {
            ...
            var res = await this.doPost('/commonQuestion/api/update', this.dataForEdit);
            if (res) {
      ...
      addData: async function () {
        ...
        this.$refs['addForm'].validate(async (valid) => {
          if (!valid) {
            ...
            let res = await this.doPost("/commonQuestion/api/save", this.dataForAdd);
            if (res == true) {
...
//        关闭对话框
      ...
      async toRemove(idx, row) {
        ...
        let data = await this.doPost("/commonQuestion/api/delete?id=" + row.id);
        if (data == true) {
    ...
    created: async function () {
      console.log("created....")
      this.findByCondition();
      let questionTypeList = await this.doPost("/questionType/api/findAll");
      ...
      let questionBankList = await this.doPost("/questionBank/api/findAll");
      this.questionBankList = questionBankList;
      let propertyList = await this.doPost("/property/api/findAll");
