  ...
  <div class="table">
    ...
    <el-dialog v-bind:title="dataForEdit.id ? '编辑': '添加'" :visible.sync="editDialogShow" width="60%">
      <el-form ref="editForm" :rules="rules" label-position="left" :model="dataForEdit">
        ...
        <el-form-item label="size" prop="size" :label-width="labelWidth">
          <el-input v-model="dataForEdit.size" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="seconds" prop="seconds" :label-width="labelWidth">
          <el-input v-model="dataForEdit.seconds" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="rightCount" prop="rightCount" :label-width="labelWidth">
          <el-input v-model="dataForEdit.rightCount" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="falseCount" prop="falseCount" :label-width="labelWidth">
          <el-input v-model="dataForEdit.falseCount" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="rate" prop="rate" :label-width="labelWidth">
          <el-input v-model="dataForEdit.rate" placeholder="请输入"></el-input>
        </el-form-item>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          seconds:
            [
              {required: true, message: '请输入seconds', trigger: 'blur'},
              {min: 3, max: 10, message: '长度在3-10个字符', trigger: 'blur'}
            ],
          rightCount:
            [
              {required: true, message: '请输入rightCount', trigger: 'blur'},
              {min: 3, max: 10, message: '长度在3-10个字符', trigger: 'blur'}
            ],
          falseCount:
            [
              {required: true, message: '请输入falseCount', trigger: 'blur'},
              {min: 3, max: 10, message: '长度在3-10个字符', trigger: 'blur'}
            ],
          rate:
            [
              {required: true, message: '请输入rate', trigger: 'blur'},
              {min: 3, max: 10, message: '长度在3-10个字符', trigger: 'blur'}
            ],
          isDel:
            [
