...
//              {required: true, message: '请输入memo', trigger: 'blur'},
    ...
    methods: {
      ...
      findByCondition: async function () {
        let data = await this.http("/questionType/api/findByCondition?pageNum=" + this.queryForm.pageNum + "&pageSize=" + this.queryForm.pageSize, this.queryForm);
      ...
      updateData: async function () {
        ...
        this.$refs['editForm'].validate(async (valid) => {
          if (!valid) {
            ...
            var res = await this.http('/questionType/api/update', this.dataForEdit, 1000);
            if (res) {
      ...
      addData: async function () {
        ...
        this.$refs['addForm'].validate(async (valid) => {
          if (!valid) {
            ...
            let res = await this.http("/questionType/api/save", this.dataForAdd, 1000);
            if (res == true) {
...
//        关闭对话框
      ...
      async toRemove(idx, row) {
        ...
        let data = await this.http("/questionType/api/delete?id=" + row.id);
        if (data == true) {
...
//          console.log("号的", this.dataForEdit);
    ...
    created: async function () {
      ...
      let propertyListData = await this.http("/property/api/findByCondition?pageNum=1&pageSize=100", null);
